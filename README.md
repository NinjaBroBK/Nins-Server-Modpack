...
######  Modpack to Join my Server.



## Pack Requirements
- 3rd Party Launcher **OR** the Official Minecraft Launcher with [Fabric Loader](https://fabricmc.net) Installed For `Minecraft Version 1.20.1 Loader Version 18.4`
- An __Actually Mid__ Computer or Better
- (*Optional*) an __Nvidia Gpu__ (More instructions later)
...
**Both**
Depending on if you have an Nvidia GPU enable/disable the `Nvidium` Mod in the mod list of your launcher.
</details>
...
### Please Config Your Folders While On Call With Me As It Could Prevent You From Joining My Server Or Even Break It

### You're Done!
#### DM Me on Discord @NinjaBroBK and I'll run a quick survey on you to see if you can join.
